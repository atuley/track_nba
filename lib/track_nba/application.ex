defmodule TrackNba.Application do
  use Application
  ...
  def start(_type, _args) do
    ...
    opts = [strategy: :one_for_one, name: TrackNba.Supervisor]
    # IO.puts "Starting nba server"
  ...
  def config_change(changed, _new, removed) do
    TrackNbaWeb.Endpoint.config_change(changed, removed)
    :ok
  end
end
